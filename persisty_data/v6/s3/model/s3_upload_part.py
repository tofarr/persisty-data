...
from persisty_data.v6.s3.generator.s3_copy_item_key_from_upload_generator import (
    S3CopyItemKeyFromUploadGenerator,
)
from persisty_data.v6.s3.generator.s3_signed_upload_url_generator import (
    S3SignedUploadUrlGenerator,
)


class S3UploadPart(UploadPart, StoreModelABC):
    item_key: str = Attr(
        creatable=False, create_generator=S3CopyItemKeyFromUploadGenerator()
    )
    upload_url: str = Attr(
        creatable=False,
