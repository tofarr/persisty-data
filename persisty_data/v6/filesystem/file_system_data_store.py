...
from persisty_data.v6.filesystem.file_system_file_handle import (
...
from persisty_data.v6.model.file_handle import (
    create_stored_file_handle_type,
    FileHandle,
)
from persisty_data.v6.model.upload import create_stored_upload_type, Upload
from persisty_data.v6.model.upload_part import (
    create_stored_upload_part_type,
    UploadPart,
)
...
class FileSystemDataStore(DataStoreABC):
    ...
    def create_store_meta(
        ...
        upload_part = type(
            type_name + "UploadPart", (FileSystemUploadPart, DataDirectoryMixin), {}
        )
